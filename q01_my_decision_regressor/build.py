...
def my_decision_regressor(X_train,X_test,y_train,y_test,param_grid):
    ...
    ret_estimates = {}
    ret_estimates['max_depth'] = best_estimator.max_depth
    ret_estimates['max_leaf_nodes'] = best_estimator.max_leaf_nodes
    ret_estimates['max_features'] = best_estimator.max_features
    return r2,ret_estimates    
