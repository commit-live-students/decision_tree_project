...
def decision_regressor_plot(X_train,X_test,y_train,y_test,depths):
    ...
    for depth in depths:
        ...
        mean_square_errors_test.append(mean_squared_error(y_test,y_pred_test))
        mean_square_errors_train.append(mean_squared_error(y_train,y_pred_train))
    plt.plot(depth_list,mean_square_errors_train)
    plt.plot(depth_list,mean_square_errors_test)
